...
.ac-stat-total { background: color-mix(in srgb, var(--accent) 6%, transparent); }
...
.ac-stat-total .ac-stat-val { color: var(--accent); }
...
.ac-row:hover    { background: var(--surface); }
.ac-row.selected { background: color-mix(in srgb, var(--accent) 10%, transparent); }
...
.ac-detail-actions { display: flex; gap: 10px; }
...
.ac-items-head, .ac-items-row {
  display: grid;
  grid-template-columns: 1fr 72px 72px 96px 96px;
  gap: 0;
}
...
.ac-items-head span, .ac-items-row span {
  padding: 12px 14px;
  border-bottom: 1px solid var(--border);
}

.ac-items-row:last-child span { border-bottom: none; }

.ac-items-row span:not(:first-child) { text-align: right; }
.ac-items-head span:not(:first-child) { text-align: right; }
...
.ac-pitems-head {
  display: grid;
  grid-template-columns: 1fr 90px 80px 110px 90px 20px;
  gap: 6px;
  padding: 0 4px 6px;
  font-size: 14px;
  font-weight: 600;
...
.ac-pitems { display: flex; flex-direction: column; gap: 8px; }
